...
const trackLocation_middleware_1 = require("./middlewares/trackLocation.middleware");
...
// professional route
app.get("/", trackLocation_middleware_1.trackLocationByLatLng, home_controller_1.homeRoute);
app.use("/api", trackLocation_middleware_1.trackLocationByLatLng, module_route_1.firstVersionRouter);
app.use("/api", trackLocation_middleware_1.trackLocationByLatLng, admin_route_1.adminRouter);
app.use("/api", trackLocation_middleware_1.trackLocationByLatLng, service_route_1.riderRouter);
