...
router.get("/all-rides", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.ADMIN), admin_controller_1.getAllRides);
router.get("/ride/:id", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.ADMIN, user_interface_1.UserRole.DRIVER, user_interface_1.UserRole.RIDER), admin_controller_1.getRideById);
