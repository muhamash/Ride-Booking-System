...
router.patch("/suspend-driver/:id/:suspendParam", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.ADMIN), admin_controller_1.suspendDriverById);
router.patch("/block-user/:id/:blockParam", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.ADMIN), admin_controller_1.blockUserById);
router.patch("/approve-driver/:id/:approveParam", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.ADMIN), admin_controller_1.approvalDriver);
router.delete("/delete-blocked-user/:id", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.ADMIN), admin_controller_1.deleteBlockedUser);
router.delete("/ride/:id", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.ADMIN), admin_controller_1.deleteRide);
