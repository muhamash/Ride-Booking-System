...
router.post("/accept-ride-request/:id", (0, checkAuth_middleware_1.checkAuth)(user_interface_1.UserRole.DRIVER), updateUserLocation_middleware_1.updateUserLocationIntoDb, driver_controller_1.acceptRideRequest);
